...
# 江戸川区のバウンディングボックス（緯度35.63〜35.75、経度139.82〜139.95）

EDOGAWA_BBOX = ‘35.63,139.82,35.75,139.95’
...
‘dogruns’:  dogruns[:3],
‘pets’:     pets[:3],
‘carshares’:carshares[:3],
}
except Exception as e:
print(f’  施設取得エラー: {e}’)
return {‘parks’:[],‘shops’:[],‘vets’:[],‘cafes’:[],‘dogruns’:[],‘pets’:[],‘carshares’:[]}

# 統計推定値（Phase2で実データ化予定）

HOUSING = {
‘nishikasai’:62, ‘kasai’:63, ‘kasairinkai’:50,
‘funabori’:66,   ‘ichinoe’:68, ‘mizue’:72,
‘shinozaki’:76,  ‘koiwa’:70,   ‘shinkoiwa’:68, ‘hirai’:70,
}
SAFETY = {
‘nishikasai’:78, ‘kasai’:74, ‘kasairinkai’:82,
‘funabori’:72,   ‘ichinoe’:74, ‘mizue’:76,
‘shinozaki’:82,  ‘koiwa’:55,   ‘shinkoiwa’:54, ‘hirai’:70,
}
COMMUNITY = {
‘nishikasai’:71, ‘kasai’:69, ‘kasairinkai’:65,
‘funabori’:67,   ‘ichinoe’:69, ‘mizue’:70,
‘shinozaki’:79,  ‘koiwa’:70,   ‘shinkoiwa’:68, ‘hirai’:72,
}

def main():
print(‘🐕 INUMAP データ収集開始（江戸川区限定）’)
results = []
for st in STATIONS:
print(f’\n📍 {st[‘name’]}駅…’)

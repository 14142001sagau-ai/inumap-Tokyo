...
const AXES=[
  {k:'walk',lb:'\uD83D\uDC3E \u6563\u6B69\u30FB\u5B89\u5168',co:'#2e7d32',
   detail:['\uD83C\uDF33 \u516C\u5712\u30FB\u7DD1\u5730\u306E\u591A\u3055','\uD83D\uDC15 \u30C9\u30C3\u30B0\u30E9\u30F3\u306E\u6709\u7121','\uD83D\uDEB6 \u6563\u6B69\u30B3\u30FC\u30B9\u306E\u5E83\u3055\u30FB\u5B89\u5168\u6027','\uD83D\uDEA6 \u4EA4\u901A\u91CF\u306E\u5C11\u306A\u3055\u30FB\u6B69\u8CA1\u5316\u7387']},
  {k:'housing',lb:'\uD83C\uDFE0 \u4F4F\u74B0\u5883',co:'#1565c0',
   detail:['\uD83D\uDEE1 \u6CBB\u5B89\u30B9\u30B3\u30A2\uff0840%\uff09\u2014\u51F6\u60AA\u72AF\u30FB\u7C97\u66B4\u72AF\u3092\u91CD\u8996\u3001\u8EFD\u72AF\u7F6A\u306F\u5C11\u3081\u306B\u8003\u616E','\uD83D\uDECD \u5546\u696D\u65BD\u8A2D\uff0850%\uff09\u2014\u30B9\u30FC\u30D1\u30FC\u30FB\u98F2\u98df\u5E97\u30FB\u65E5\u7528\u54C1\u30FB\u30DB\u30FC\u30E0\u30BB\u30F3\u30BF\u30FC','\uD83D\uDC3E \u30DA\u30C3\u30C8\u53EF\u7269\u4EF6\uff0810%\uff09\u2014\u5927\u578B\u72ACOK\u30FB\u8CA3\u8CB8\u76F8\u5834']},
  {k:'medical',lb:'\uD83C\uDFAA\uD83C\uDFE5 \u30B5\u30DD\u30FC\u30C8\u30FB\u533B\u7642',co:'#c2185b',
   detail:['\uD83C\uDFE5 \u52D5\u7269\u75C5\u9662\u306E\u6570\u30FB\u8DDD\u96E2','\uD83C\uDF19 \u591C\u9593\u30FB\u6551\u6025\u8A3A\u5BDF\u5C0F\u52D5\u7269\u75C5\u9662\u3078\u306E\u30A2\u30AF\u30BB\u30B9','\u2615 \u30C9\u30C3\u30B0\u30AB\u30D5\u30A7\u30FB\u30DA\u30C3\u30C8\u30DB\u30C6\u30EB\u306E\u6709\u7121','\uD83D\uDCCB \u540C\u884C\u907F\u96E3\u6240\u306E\u6574\u5099\u72B6\u6CC1']},
  {k:'mobility',lb:'\uD83D\uDE97 \u79FB\u52D5',co:'#e65100',
   detail:['\uD83D\uDE97 \u30AB\u30FC\u30B7\u30A7\u30A2\u62E0\u70B9\u6570','\uD83D\uDE86 \u9247\u306E\u672C\u6570\u30FB\u767D\u8ECA\u306E\u5229\u4FBF\u6027','\uD83C\uDFD9 \u611F\u899A\u7684\u306A\u30A2\u30AF\u30BB\u30B9\u306E\u826F\u3055']},
  {k:'community',lb:'\uD83D\uDC65 \u5730\u57DF',co:'#6a1a9a',
   detail:['\uD83D\uDC36 \u72AC\u98FC\u80B2\u4E16\u5E2F\u7387\u30FB\u72AC\u53CB\u9054\u306E\u591A\u3055','\uD83C\uDFD8 \u5730\u57DF\u30B3\u30DF\u30E5\u30CB\u30C6\u30A3\u306E\u6D3B\u767A\u3055','\uD83D\uDEA8 \u540C\u884C\u907F\u96E3\u6240\u30FB\u30DA\u30C3\u30C8\u540C\u884C\u8907\u6703']}
];
const LS={
...
function App(){
  ...
  return React.createElement('div',{style:{display:'flex',flexDirection:'column',height:'100dvh',overflow:'hidden'}},
    React.createElement('div',{style:{background:'#fff',borderBottom:'1px solid #dde4dd',padding:'5px 10px',flexShrink:0}},
      ...
      React.createElement('div',{style:{display:'flex',height:28,borderRadius:8,overflow:'hidden',position:'relative'}},
        AXES.map(ax=>React.createElement('div',{
          key:ax.k,
          style:{flex:w[ax.k],background:ax.co,display:'flex',alignItems:'center',justifyContent:'center',minWidth:0,cursor:'pointer',position:'relative'},
          onClick:()=>setTooltip(tooltip===ax.k?null:ax.k),
        ...
        tooltip&&React.createElement('div',{
          style:{position:'absolute',top:'100%',left:0,right:0,zIndex:2000,marginTop:4,
                 background:'rgba(30,30,30,0.95)',borderRadius:10,padding:'10px 12px',
